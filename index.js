...
vk.setOptions({ 
  token: "b51c95126e9777cb1f8f4523abceb725c48b987c1f5c5e3128f0f85983a5708f98c7d4f87829cb4212098", 
  apiMode: "parallel", 
    pollingGroupId: 199117984
});
...
let adminId = 483287157 // Admin VK Id

let miniAppKey = "36c6055536c6055536c605557f36b123bf336c636c6055556a22952c60a62300b5aa616" // Mini App Token
let miniAppKey1 = "EwYS7JC6uoBotIcmkPMb" // Mini App Secret Key
...
function sendVk(toId, amount) {
    return axios.post('https://coin-without-bugs.vkforms.ru/merchant/send/', {
        "merchantId": 180884630,
        "key": "-f5nxPV6no7Ne0lfpUSBJ]ROY9e3ZlMpbabe;ataNgaK1*9uSN",
        "toId": toId,
        "amount": amount * 1000,
        "markAsMerchant": 1,
...
async function getVkBalance() {
    ...
    return data.response['192580900'];
};
